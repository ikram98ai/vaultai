...
export function Sidebar() {
  ...
  return (
    <aside className={`sidebar ${sidebarOpen ? 'active' : ''}`}>
      {/* VaultAI Logo */}
      <button className="sidebar-logo" id="homeLogoBtn" title="Home" onClick={handleHomeClick}>
        <svg width="28" height="31" viewBox="0 0 28 31" fill="none" xmlns="http://www.w3.org/2000/svg" className="vaultai-logo">
          <path
      ...
      <div className="sidebar-top">
        ...
        <div className="sidebar-search">
          <div className="search-wrapper">
            ...
            <input type="text" placeholder="Search ⌘K" className="search-input" />
          </div>
        </div>
        ...
        <nav className="sidebar-nav">
          ...
          >
            ...
            <span>Chat</span>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" width="16" height="16" className="nav-item-plus">
      ...
      <div className="sidebar-footer">
        <button className="account-btn" id="accountBtn" onClick={openProfileModal}>
